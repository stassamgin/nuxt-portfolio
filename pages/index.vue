        ...
        experience: {
          ...
          data: [
            ...
            },
            {
              ...
              startAt: '01.04.2013',
              endAt: '01.04.2015',
              description: 'руг обязанностей: договорная работа; подготовка, составление, юридический анализ, переговоры при заключении, изменении, прекращении различных договоров, контроль за исполнением; текущее правовое обслуживание деятельности предприятия. Осуществление частной практики в сфере градостроительства и автострахования.\n'
            },
          ]
        }
      }
